...
If you'd like to **contribute** and make this much better for other users, have a look at [Issues](https://github.com/venkateshsundaram/developerFolio/issues).

Created something awesome for your fork of the portfolio and want to share it? Feel free to open a [pull request](https://github.com/venkateshsundaram/developerFolio/pulls).
...
git clone https://github.com/venkateshsundaram/developerFolio.git
...
If the above solution still doesn't work, visit the [wiki page](https://github.com/venkateshsundaram/developerFolio/wiki/Github-Setup-For-Open-Source-Projects).
...
const greeting = {
  ...
  resumeLink: "https://docs.google.com/document/d/1yjaqoDTW10ABVjmIfCB779ax2oNLqbSzQ3XyQSHHVr8/edit?usp=sharing"
};
...
[![Deploy To Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/venkateshsundaram/developerFolio)
...
## For the Future
If you can help us with these. Please don't hesitate to open a [pull request](https://github.com/venkateshsundaram/developerFolio/pulls).
